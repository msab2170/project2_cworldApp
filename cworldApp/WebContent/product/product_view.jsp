<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ include file="mobile_inc_header.jsp" %> 
<%@ page import="vo.*" %>
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/jquery/latest/jquery.min.js?autoload=false"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/latest/moment.min.js?autoload=false"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js?autoload=false"></script>
<script>
...
<table width="<%=pageWidth %>" cellpadding="5">
<tr>
<td width="*">
	...
	<a href="#pr3"><span style="color:blue; margin-left:10px;"><br/>(후기 <%=pdtInfo.getPi_review() %> 개)</span></a>
...
<% if (piid.charAt(0) == 'R' || piid.charAt(0) == 'P'){ %>
	...
	<%if (pdtInfo.getPi_dc() > 0) {%>
		할인전 : <del><%=pdtInfo.getPi_price() %>원</del><br/>
	...
	<br/><span class="periods"></span><br/>
	(재고 : <input type="text" name="opt_cnt" value="<%=pdtStockList.get(0).getPs_stock() %>" size="1" readonly="readonly" style="border:0px; background:0px;" /> 개 남음)
...
<div class="pdtvc">
	<img src="/cworldSite/pdt_img/<%=pdtInfo.getPi_desc()%>" width="<%=pageWidth %>"  id="descImg" style="min-height:400px;"/>
</div>
<br/><br/><br/>
<div class="pdtVDiv">
...
<div class="pdtvc">	
	<img src="/cworldSite/img/order_notice.png" width="<%=pageWidth %>" style="padding:0; margin:0;"/>
</div>
<br/><br/><br/>
<div class="pdtVDiv">
...
<%	for (int i = 0 ; i < reviewList.size() ; i++ ){
		...
		<%}  %>
		<tr><td class="pvrt"><br/><%=ri.getRl_title() %><br/><br/><%=ri.getRl_content() %><br/><br/></td></tr>	
<%	} %>
	</table>
<%} else {%>
